...
@section('content')
<div class="container">
<h1 class="h3 mb-3 font-weight-normal">Register as a broker or an agency</h1>
<div class="card">
  <div class="card-body">
    <form class="form-signin" id="form-register-broker" method="POST" action="/register">
      {{--
  @include ('partials.errors') --}} {{ csrf_field() }}
      ...
      <input name="user_type" type="hidden" id="hidden" class="form-control mt-2" value="broker">
